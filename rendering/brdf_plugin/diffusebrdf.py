...
class MyBSDF(mi.BSDF):
    def __init__(self, props):
        ...
        self.eta = 1.33
        self.sh_coeffs = props['sh_coeffs']
        self.sh_coeffs = mi.Float(self.sh_coeffs)
    ...
    def traverse(self, callback):
        ...
        callback.put_parameter('sh_coeffs', self.sh_coeffs, mi.ParamFlags.Differentiable)

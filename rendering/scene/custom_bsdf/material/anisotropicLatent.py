...
class AnisotropicLatentTexturedModel(LightningModule):
    ...
    def __init__(self, cfg):
        ...
        # instead. Does NOT change construction — latent_texture still
        ...
        self.use_neural_geometry_at_eval = getattr(cfg.neural_geometry, 'use_at_eval', True) \
    ...
    def eval_brdf(
        ...
        G = (wi * predicted_normal).sum(-1, keepdim=True).clamp(min=0.0)
        brdf=brdf*G
